...
public class ABB<E extends Comparable<E>> {
     ...
     */
    public ABB(E[] v) {        
        //Podriamos ordenar el vector v con cualquier algoritmo de ordenacion (no espicifican que hacer en este caso :,( )
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        ...
        if(ini<=fin){
            bbsita = new NodoABB(emitad, construirEquilibrado(v,ini,mitad-1), construirEquilibrado(v,mitad+1,fin));
        }
        else{bbsita = null;}
        return bbsita;
    }
