...
plt.plot(epoch, err_training, label='test')
plt.plot(epoch, err_validation, label='validacion')
plt.xlim(0,100)
plt.legend(loc='upper right')
plt.title('Grafico de errores-epocas')
plt.show()