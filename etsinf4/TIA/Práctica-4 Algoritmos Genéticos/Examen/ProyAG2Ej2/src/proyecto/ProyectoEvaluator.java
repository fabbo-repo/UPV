...
public class ProyectoEvaluator implements Evaluator<ArrayList<TTramo>>{
	public Objectives evaluate(ArrayList<TTramo> phenotype) {
		...
		for(int i = 0; i < phenotype.size(); i++) {
			...
			if(i == 1) tramoP2 = tramo;
			if(i == 2) tramoP3 = tramo;
			if(i == 6) tramoP7 = tramo;
			if(i == 9) tramoP10 = tramo;
			if(i == 11) tramoP12 = tramo; 
			if(tramo != 0)
		...
		// Bonificacion tramos
		if(tramoP2 == tramoP3 && tramoP3 == tramoP7) befSUM +=5;
		// Penalizacion tramos
		if(tramoP10 == tramoP12) {
			befSUM = Double.NEGATIVE_INFINITY;
		}
