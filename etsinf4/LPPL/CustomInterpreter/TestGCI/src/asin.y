                                                ...
                                                if($5.tipo != T_ERROR){
                                                    if(simb.t == T_ERROR)
                                                        ...
                                                        if(campo.t == T_ERROR)
                                                            ...
                                                            $$ = $5.tipo;
                                                            /*GCI*********************/
                                                            emite(EASIG, crArgPos(niv, $5.valor), crArgNul(), crArgPos(simb.n, simb.d+campo.d));
                                                        }
                                                    }
                                                }
                                            }
    ...
    : IF_ APAR_ expresion CPAR_                                     
                                            {
                                                if($3.tipo != T_ERROR && $3.tipo != T_LOGICO)
                                                    ...
                                                    emite(EIGUAL, crArgPos(niv, $3.valor), crArgEnt(0), crArgEtq(-1));
                                                }
                                            } 
    instruccion 
                                            {
    ...
    APAR_ expresion CPAR_          
                                            {
                                                if($4.tipo != T_ERROR && $4.tipo != T_LOGICO)
                                                    ...
                                                    emite(EIGUAL, crArgPos(niv, $4.valor), crArgEnt(0), crArgEtq(-1));
                                                }
                                            }
    instruccion
                                            {
    ...
    | expresionIgualdad operadorIgualdad expresionRelacional        
                                            {
                                                ...
                                                if($1.tipo != T_ERROR && $3.tipo != T_ERROR) {
                                                    if($1.tipo != $3.tipo) 
                                                        ...
                                                        $$.valor = creaVarTemp();
                                                        emite(EASIG, crArgEnt(1), crArgNul(), crArgPos(niv, $$.valor));
                                                        emite($2, crArgPos(niv, $1.valor), crArgPos(niv, $3.valor), crArgEtq(si+2));
                                                ...
                                                if($2.tipo != T_ERROR) {
                                                    if($2.tipo == T_ENTERO) {
                                                        if($1 == ESIG) 
                                                            ...
                                                            /*GCI*********************/
                                                            $$.valor = creaVarTemp();
                                                            emite(ESIG, crArgPos(niv, $2.valor), crArgNul(), crArgPos(niv, $$.valor));
                                                        }
                                                    }
