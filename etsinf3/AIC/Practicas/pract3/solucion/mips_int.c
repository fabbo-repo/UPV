            ...
            switch (solucion_riesgos_datos) {
                ...
                case cortocircuito:
                    ...
                    if(escribe_Rdst(MEM_WB.IR)
                        && ((lee_Rfte1(ID_EX.IR) && (ID_EX.IR.Rfuente1 == MEM_WB.IR.Rdestino))
                        || (lee_Rfte2(ID_EX.IR) && (ID_EX.IR.Rfuente2 == MEM_WB.IR.Rdestino)))) {
                        WBaEXalu_s = SI;
                        result = wb;
                    }
                    ...
                    if(escribe_Rdst(EX_MEM.IR)
                        && ((lee_Rfte1(ID_EX.IR) && (ID_EX.IR.Rfuente1 == EX_MEM.IR.Rdestino))
                        || (lee_Rfte2(ID_EX.IR) && (ID_EX.IR.Rfuente2 == EX_MEM.IR.Rdestino)))) {
                        MEMaEXalu_s = SI;
                        result = mem;
                    }
                    break;
...
void detectar_riesgos_datos(void) {
    ...
    switch (solucion_riesgos_datos) {
        case parada:
            ...
            || (lee_Rfte2(IF_ID.IR) && (IF_ID.IR.Rfuente2 == EX_MEM.IR.Rdestino))) ) {
                IFstall = SI;
                IDstall = SI;
            }
