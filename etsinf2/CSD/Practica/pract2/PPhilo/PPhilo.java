...
public class PPhilo extends JPanel implements ActionListener {
    ...
    void simulate(String s) {
        ...
        switch (type) {
            ...
            case 1: //Todo los hilos cogen su tenedor derecho menos el 4 que coge el izquierdo
            ...
            case 2: //Todo los hilos pares cogen su tenedor derecho y el resto cogen el izquierdo
            ...
            case 3: //Todo los hilos cogen su tenedor derecho e izquierdo, o ninguno
            ...
            case 4: //Máximo de 4 filósofos sentados en la mesa
