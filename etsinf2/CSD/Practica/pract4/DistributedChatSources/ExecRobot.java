...
public class ExecRobot{
    public static void main(String[] args){
        try{
            ...
            System.out.println("ChatRovot activado");
            ...
            for(int i = 0; i < n; i++){
                System.out.println("ChatClient "+(i+1));System.out.print("myPort:(Recomendaciom: desde 9005) ");final int myport = Integer.parseInt(cmd.nextLine());System.out.println();
                if(nhost.length()!=0){
