package theantsproblem.Ejercicio3;
...
public class Ant extends Thread {
    protected int id;
    protected Territory3 land;//Cambiar por Territory, Territory2
    protected Random rnd;
    protected int steps;
    protected int posX, posY; // current position
    protected int nextPosX, nextPosY; // next position for movement
    protected CyclicBarrier b;

    public Ant(int id0, int x0, int y0, Territory3 t, int stepsAnt, CyclicBarrier barrier) {
        id = id0;
        posX = x0;
        posY = y0;
        land = t;
    ...
    public void run() {
        ...
        try {
            b.await();//Hacer esto tiene un inconveniente, que lo explico en el pdf
        } catch (Exception ex) {}
