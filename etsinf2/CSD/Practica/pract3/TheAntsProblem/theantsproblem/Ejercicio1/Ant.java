package theantsproblem.Ejercicio1;
...
public class Ant extends Thread {
    protected int id;
    protected Territory1 land;//Cambiar por Territory, Territory2
    ...
    public Ant(int id0, int x0, int y0, Territory1 t, int stepsAnt, CyclicBarrier barrier) {
        id = id0;
        posX = x0;
        posY = y0;
        land = t;
