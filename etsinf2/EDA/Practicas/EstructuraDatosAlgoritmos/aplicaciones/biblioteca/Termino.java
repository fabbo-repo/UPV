...
public class Termino {
    ...
    public int hashCode() { 
        ...
        if (res != 0) { return res; }
        int mult = 1;
        for(int i = this.termino.length()-1; i >= 0 ; i--){
            res += this.termino.charAt(i) * mult;
            mult *= this.baseHashCode;
            
            //Otra forma es: res=(res*this.baseHashCode)+this.termino.charAt(i);
        }
    ...
    public boolean equals(Object otro) {
        ...
        && ((Termino) otro).termino.equals(this.termino);
    }
